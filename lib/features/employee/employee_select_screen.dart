      ...
      builder: (ctx, bc) {
        ...
        return Column(
          children: [
            ...
            Expanded(
              child: Padding(
                padding: EdgeInsets.fromLTRB(horiz, 8, horiz, 24),
                child: Center(
...
// ─────────────────────────────────────────────────────────────
// Bandeau bas : "X en service · Y en pause · KLOK" + accès admin
// ─────────────────────────────────────────────────────────────
class _BottomBand extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: EdgeInsets.symmetric(horizontal: horiz, vertical: 14),
      child: Row(
      ...
      child: ConstrainedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Ajoute ton équipe depuis la page admin pour commencer à pointer.',
              textAlign: TextAlign.center,
